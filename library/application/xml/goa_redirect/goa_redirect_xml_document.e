...
feature -- Adding Elements
	...
	add_text_item_element (choice_N2_name_code: INTEGER; choice_N2_value: STRING; text_to_add: STRING) is
		...
		do
			...
			if choice_N2_name_code /= xml_null_code then
				writer.set_attribute (attribute_name_for_code (choice_N2_name_code), choice_N2_value)
			end
...
feature -- {NONE} -- Element Content Validity
	...
	redirect_content_validity: GOA_XML_ELEMENT_SCHEMA is
		...
		once
			create Result.make
			Result.add_zero_or_more_element (<<paragraph_element_code, division_element_code, hyperlink_element_code, text_item_element_code, table_element_code, popup_hyperlink_element_code, hyperlink_element_code, image_element_code>>)
		end
...
feature {NONE} -- Transformation
	...
	schema_file_name: STRING is
		...
		once
			Result := configuration.data_directory + "goa_redirect.frng"
		end
