...
feature -- Basic operations
	...
	read_request is
		...
		local
			...
			httpd_response: HTTPD_SERVLET_RESPONSE
			request: STRING
			socket: TCP_SOCKET
		do
			...
			if socket_ok then
				...
				if socket_ok then
					...
					if socket_ok then
						...
						create {HTTPD_SERVLET_REQUEST} last_request.make (http_request, httpd_response)
...
end -- class GS_STANDALONE_CONNECTOR
