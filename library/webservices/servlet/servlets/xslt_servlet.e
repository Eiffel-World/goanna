...
feature -- Basic operations
	...
	do_get (a_req: HTTP_SERVLET_REQUEST; a_resp: HTTP_SERVLET_RESPONSE) is
			-- Process GET request
		local
	...
	do_post (a_req: HTTP_SERVLET_REQUEST; a_resp: HTTP_SERVLET_RESPONSE) is
			-- Process GET request
		do
			do_get (a_req, a_resp)
		end
...
feature {NONE} -- Implementation
	...
	apply_transform (a_transform_uri, an_initial_template, an_initial_mode, a_source_uri, a_medium, a_title: STRING; a_clear_cache_request: BOOLEAN; a_resp: HTTP_SERVLET_RESPONSE) is
